...
import toast from 'react-hot-toast'
    ...
    return (
        ...
        to-[#000000]/30 border-r border-[#80609F]/30 backdrop-blur-3x1 
        ...
        <div className='flex-1 overflow-y-scroll mt-3 text-sm space-y-3'>
            ...
            .map((chat) => (
                ...
                key={chat._id}
                className='p-2 px-4 dark:bg-[#57317C]/10 border border-gray-300 dark:border-[#80606F]/15 rounded-md cursor-pointer flex justify-between group'>
                <div>
        ...
        dark:border-white/15 rounded-md cursor-pointer group'>
            ...
            {user && <img onClick={logout} src={assets.logout_icon} className='h-5 ursor-pointer hidden not-dark:invert group-hover:block'/>}
        </div>
        <img onClick={()=>setIsMenuOpen(false)} src={assets.close_icon} className='absolute top-3 right-3 
        w-5 h-5 cursor-pointer md:hidden not-dark:invert' alt=''/>
