      ...
      {images.length > 0 ? (
        <div className='flex flex-wrap max-sm:justify-center gap-5'>
          {images.map((item, index)=>(
            <a key={index} href={item.imageUrl} target='__blank' className='relative group block rounded-lg overflow-hidden border 
            ...
            group-hover:sccale-105 transition-transform duration-300 ease-in-out'/>
